...
const ZONES = [
  {
    ...
    max: 55,
    color: "#94a3b8",
    desc: "Very easy spinning. Good for warm-up, cool-down, or recovery days.",
  },
  {
    zone: 2,
    name: "Endurance",
    ...
    max: 75,
    color: "#4ade80",
    desc: "All-day pace. Builds aerobic base. Most of your training volume.",
  },
  {
    zone: 3,
    name: "Tempo",
    ...
    max: 90,
    color: "#facc15",
    desc: "Comfortably hard. Improves sustained power and efficiency.",
  },
  {
    zone: 4,
    ...
    max: 105,
    color: "#fb923c",
    desc: "Your FTP zone. Race pace for 40–60 min efforts. Hard but sustainable.",
  },
  {
    zone: 5,
    name: "VO₂ Max",
    ...
    max: 120,
    color: "#f87171",
    desc: "3–8 min efforts. Builds maximum aerobic power. Very hard.",
  },
  {
    zone: 6,
    ...
    max: 150,
    color: "#c084fc",
    desc: "30 sec – 2 min all-out. Builds anaerobic capacity.",
  },
  {
    zone: 7,
    name: "Neuromuscular",
    ...
    max: null,
    color: "#ec4899",
    desc: "Short explosive sprints under 30 sec. Maximum power output.",
  },
] as const;
    ...
    <SafeAreaView style={styles.safe} edges={["bottom"]}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text style={styles.subtitle}>
          Coggan 7-zone model. Enter your FTP to see training zones.
        </Text>
              ...
              <View style={styles.unitToggle}>
                {(["watts", "pct"] as DisplayUnit[]).map((u) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.unitBtn,
                      displayUnit === u && styles.unitBtnActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.unitText,
                        displayUnit === u && styles.unitTextActive,
                      ]}
                    >
                      {u === "watts" ? "Watts" : "% FTP"}
                    </Text>
        ...
        {valid ? (
          <>
              ...
              return (
                <View key={z.zone} style={styles.zoneCard}>
                  ...
                  <View style={styles.zoneRow}>
                    ...
                    >
                      <Text style={[styles.zoneBadgeText, { color: z.color }]}>
                        Z{z.zone}
                      </Text>
                    </View>
                    ...
                    >
                      <Text style={[styles.rangeText, { color: z.color }]}>
                        {rangeLabel}
                      </Text>
                    </View>
                  </View>
            ...
            <View style={styles.ftpNote}>
              <Text style={styles.ftpNoteText}>
                ...
                Functional Threshold Power is the highest average power you can
                sustain for ~60 minutes. Common test: ride all-out for 20 min,
          ...
          <View style={styles.emptyState}>
            <Text style={styles.emptyText}>
              Enter your FTP above to see your power zones
            </Text>
          </View>
        )}
      </ScrollView>
